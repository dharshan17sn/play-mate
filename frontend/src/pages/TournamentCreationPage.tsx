...
const TournamentCreationPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="md:hidden bg-white shadow sticky top-0 z-20">
        <div className="px-4">
          <div className="flex items-center justify-between h-14">
            ...
            <h1 className="text-lg font-bold text-gray-900">Create Tournament</h1>
      ...
      {/* Main Content */}
      <main className="max-w-3xl mx-auto py-6 sm:px-6 lg:px-8 pb-20 md:pb-6">
        <div className="px-4 py-6 sm:px-0">
          <div className="bg-white rounded-lg shadow">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-900">Create New Tournament</h2>
              <p className="mt-1 text-sm text-gray-600">Fill in the details to create your tournament</p>
            </div>
